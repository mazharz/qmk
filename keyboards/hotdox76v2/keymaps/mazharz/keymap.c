...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ergodox_pretty(
        KC_NO,   KC_1,   KC_2,   KC_3,    KC_4,          KC_5,   KC_NO,       KC_NO, KC_6,    KC_7,         KC_8,    KC_9,   KC_0,    TG(3),
        ...
        KC_NO,   KC_NO,  KC_NO,  KC_LGUI, LT(1,KC_SPC),                                       LT(1,KC_SPC), KC_LGUI, KC_NO,  KC_NO,   KC_NO,
                                                         KC_NO,  KC_NO,       KC_NO, KC_NO,
                                                                 KC_NO,       KC_NO,
                                          LT(2,KC_BSPC), KC_DEL, KC_NO,       KC_NO, KC_CAPS, LT(2,KC_ENT)
    ),
    /*
     * ┌──────┬───┬───┬───┬───┬───┬───┐       ┌───┬───┬───┬───┬───┬───┬──────┐
     * │      │ 1 │ 2 │ 3 │ 4 │ 5 │   │       │   │ 6 │ 7 │ 8 │ 9 │ 0 │      │
    ...
    /*
     * game mode - toggled on and off by the top right 1.5u key (GME on layer 0).
     * same as layer 0 without the home row mods; real modifiers get their own
     * keys instead - shift stays left of z, ctrl sits below it, alt sits left
     * of the standalone gui. this layer sits above layers 1 and 2 and is fully
     * populated, so those layers are unreachable while it is on - space and the
     * thumb keys are plain keycodes here rather than layer taps.
     *
     * ┌──────┬───┬───┬───┬───┬───┬───┐       ┌───┬───┬───┬───┬───┬───┬──────┐
     * │      │ 1 │ 2 │ 3 │ 4 │ 5 │   │       │   │ 6 │ 7 │ 8 │ 9 │ 0 │  GME │
     * ├──────┼───┼───┼───┼───┼───┼───┤       ├───┼───┼───┼───┼───┼───┼──────┤
    ...
    [3] = LAYOUT_ergodox_pretty(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_NO,       KC_NO, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_LCTL, KC_NO,   KC_LALT, KC_LGUI, KC_SPC,                               KC_SPC,  KC_LGUI, KC_NO,   KC_NO,   KC_NO,
                                                     KC_NO,   KC_NO,       KC_NO, KC_NO,
                                                              KC_NO,       KC_NO,
                                            KC_BSPC, KC_DEL,  KC_NO,       KC_NO, KC_CAPS, KC_ENT
    )
};
